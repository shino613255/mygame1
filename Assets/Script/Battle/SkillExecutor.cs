...
public static class SkillExecutor
{
    ...
    public static Result Execute(UnitBase attacker, UnitBase target, SkillData skill, BodyPart part = BodyPart.Body, float targetEvasion = 0f)
    {
        ...
        // 追加効果（状態異常）
        ApplyStatusEffect(attacker, target, skill, part, ref r);
    ...
    private static void ApplyStatusEffect(UnitBase attacker, UnitBase target, SkillData skill, BodyPart part, ref Result r)
    {
